              ...
              {[
                {
                  ...
                  desc: "Sign in with email or Google in seconds. Lisa instantly creates your dedicated workspace and pre-configures your brand voice profile.",
                  delay: 0,
                },
                {
                  stage: "02",
                ...
                },
                {
                  ...
                  desc: "Paste your idea into the Content Studio. Lisa generates platform-native drafts, you review each one, edit what you like, and approve.",
                  delay: 160,
                },
                {
                  stage: "04",
                  ...
                  desc: "Approved posts go live on schedule across every channel. Lisa tracks performance and shows you what to create next.",
                  delay: 240,
                },
              ].map((item, idx) => {
